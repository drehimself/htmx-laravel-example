...
<body>
    <div class="container mx-auto">
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 lg:py-16 px-4 mx-auto grid grid max-w-screen-lg">
                ...
                <div class="grid grid-cols-2 gap-12">
                    <form
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500 dark:shadow-sm-light" placeholder="Enter your name">
                            @error('name')
                        ...
                        <div class="mt-8"><button type="submit" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-indigo-700 sm:w-fit hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create User</button></div>
                    </form>
                ...
                <div id="another-error"></div>
                {{-- <div>Some more stuff here</div> --}}
                <div id="one-more-error"></div>
            </div>
        </section>
    </div>
</body>
